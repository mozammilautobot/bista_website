    ...
    >
      ...
      >
        ...
        <motion.path
          ...
          strokeWidth={dark ? 4.5 : hero ? 3 : 2.5}
          strokeLinecap="round"
        ...
        <motion.path
          ...
          stroke="url(#phenomFlowGrad)"
          strokeWidth={dark ? 3.5 : hero ? 2.5 : 2}
          strokeLinecap="round"
          style={{ opacity: lineOpacity * 0.8 }}
          animate={{ y: [0, -22, 0] }}
          transition={{ duration: 21, repeat: Infinity, ease: "easeInOut" }}
        />
        <motion.path
          ...
          stroke="url(#phenomFlowGrad)"
          strokeWidth={dark ? 2.75 : hero ? 2 : 1.5}
          strokeLinecap="round"
          style={{ opacity: lineOpacity * 0.6 }}
          animate={{ y: [0, 18, 0] }}
